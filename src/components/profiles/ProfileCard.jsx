...
const ProfileCard = ({ profile, onSelect }) => {
  ...
  return (
    ...
    >
      <div className="w-32 h-32 rounded-lg overflow-hidden border-4 border-transparent group-hover:border-red-600 mb-4 transition-all duration-300 bg-gray-700">
        <img
          src={profile.isChild ? "/images/profiles/default-profile.png" : "/images/profiles/default-profile.png"}

...
const MovieDetail = () => {
  ...
  const fetchMovie = async () => {
    try {
      ...
      // Si es un perfil de niño y la película no es apta, redirigir a la página principal
      if (currentProfile?.isChild) {
        const isChildFriendly =
          response.data.genre === 'animation' ||
          response.data.genre === 'family' ||
          response.data.rating <= 7;
          ...
          <div className="flex justify-between items-start">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className={`flex items-center ${inWatchlist ? 'bg-red-600 text-white' : 'bg-gray-700 text-gray-300'
